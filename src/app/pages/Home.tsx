...
export function Home() {
  ...
  const skills = {
    ...
    tools: [t("tag.aiTools"), "CMS", "DAM", t("tag.agileMethods")],
  };
          ...
          <div className="max-w-[1440px] mx-auto">
            ...
            <div className="grid sm:grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 mb-12 sm:mb-16">
              ...
              >
                ...
                <p className="font-['DM_Mono'] text-[#F0EDE6]/40 text-xs">2019 – 2023</p>
              </motion.div>
              ...
              >
                ...
                <p className="font-['DM_Mono'] text-[#F0EDE6]/40 text-xs">2017 – 2019</p>
              </motion.div>
            </div>
